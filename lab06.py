...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        self.after = self.balance + amount
        self.transactions.append(Transaction(len(self.transactions),self.before,self.after))
        self.balance+=amount
        return self.balance
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(len(self.transactions),self.before,self.before))
